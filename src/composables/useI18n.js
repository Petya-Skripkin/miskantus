...
const messages = {
  de: {
    ...
    plans: {
      ...
      note: '2 Parkplaetze pro Villa in der Tiefgarage zusaetzlich',
  ...
  fr: {
    ...
    villas: {
      ...
      budgetsIntro: 'Chaque villa dispose de deux places de parking dans le garage souterrain avec acces direct, ainsi que d espaces de rangement supplementaires au sous-sol.',
    ...
    plans: {
      ...
      note: '2 places de parking par villa dans le garage souterrain en sus',
