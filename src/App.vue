    ...
    <header class="site-header">
      <div class="header-contact">
        <div>
          ...
          <div><a href="mailto:info@rewus.ch"><img :src="baseUrl + 'imgs/icons/email.webp'" alt="" /></a></div>
      ...
      <div class="width header-inner">
        ...
        <nav class="menu header-nav">
          <ul class="menu header-nav-list">
            ...
            <li><router-link to="/les-villas" class="header-nav-link">{{ t('nav.villas') }}</router-link></li>
...
const seoByRoute = {
  '/': {
    de: {
      title: 'Projekt',
      description:
        'Exklusive Residenz in Herzogenbuchsee mit hochwertigen Villen, klarer Architektur und nachhaltiger Wohnqualitaet.',
    },
    fr: {
      title: 'Projet',
      description:
        'Residence exclusive a Herzogenbuchsee avec villas haut de gamme, architecture epuree et qualite de vie durable.',
    },
  },
  '/projet': {
    de: {
  ...
  '/les-villas': {
    de: {
      title: 'Villen',
      description:
        '4.5-Zimmer-Villen mit Terrasse, privatem Garten, hochwertigen Budgets und nachhaltiger Energieversorgung.',
    },
    fr: {
      title: 'Villas',
      description:
        'Villas 4.5 pieces avec terrasse, jardin prive, finitions qualitatives et solutions energetiques durables.',
    },
  },
  '/galerie': {
    de: {
  ...
  '/plans': {
    de: {
      ...
      description:
        'Grundrisse, Flaechen, Status und Preisinformationen der Villen inklusive Download der Planunterlagen.',
    },
    fr: {
      title: 'Plans et prix',
      description:
        'Plans, surfaces, statuts et informations de prix des villas, avec telechargement des documents.',
    },
  },
  '/telechargements': {
    de: {
